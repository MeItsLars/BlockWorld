...
struct RenderResources
{
    ...
    WGPUBindGroup       CommonBindGroup = nullptr;      // Resources bind-group to bind the common res to pipeline
    ImGuiStorage        ImageBindGroups;                // Resources bind-group to bind the font/image res to pipeline (this is a key->value map)
